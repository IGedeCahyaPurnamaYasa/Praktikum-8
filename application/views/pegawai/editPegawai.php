    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="container">
              <?php echo form_open("Peminjaman_controller/editPegawai/".$pegawai->KdPetugas); ?>
              <form class="form-horizontal" action="" method="POST">
                <div class="form-group">
                  <input type="text" class="form-control" id="kode" value="<?php echo set_value('kode', $pegawai->KdPetugas) ?>" name="kode" readonly>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" id="Nama" value="<?php echo set_value('nama', $pegawai->Nama) ?>" name="nama">
                </div>
                <div class="form-group">
